...
public class StudentDataBase {
	...
	public static Supplier<Student> studentSupplier = () ->{
		...
		bike.setName("ABC");
		bike.setModel("xyz");
		Student student = new Student("Lokesh", 4, 3.9, "male", Arrays.asList("movies", "songs", "games"));
    ...
    public static List<Student> getAllStudents(){
        ...
        Student student4 = new Student("Dave",3,3.9,"male", Arrays.asList("swimming", "gymnastics","soccer"), 10);
        /**
         * 4th grade students
         */
